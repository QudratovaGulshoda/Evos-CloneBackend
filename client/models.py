...
from utils.locations import get_location

class Client(models.Model):
    name = models.CharField(max_length=100,verbose_name="Client name",help_text="Enter client name",null=True,blank=True)
    username = models.CharField(max_length=100,verbose_name="Client username",
                                help_text="Enter client username",null=True,blank=True)
    telegram_id = models.CharField(max_length=30,verbose_name="Telegram ID",help_text="Enter telegram ID",unique=True)
    language = models.CharField(max_length=10,default="uz",verbose_name="Client System Language",
                                help_text="Enter client system language")
    phone = models.CharField(max_length=100,verbose_name="Client Phone Number",
                             help_text="Enter client phone",null=True,blank=True)
